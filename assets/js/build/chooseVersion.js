...
function switchScripts() {
    if (document.getElementById("top_button").innerHTML === multilang.getKey('button-switch-random')) {
        document.getElementById("top_button").innerHTML = multilang.getKey('button-switch-logic');
    } else {
        document.getElementById("top_button").innerHTML = multilang.getKey('button-switch-random');
    }
