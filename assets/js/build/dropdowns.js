function topDropDowns() {
    ...
    function format_secondary_dropdowns(list, listItems, checkbox) {
        ...
        var listOfSubracesInDropdown = document.querySelectorAll('ul#' + listItems + ' input.race_class');
    ...
    function on_click_decider(_id, _class) {
        ...
        if (isCheckboxChecked) {
            ...
            if (input_class === 'race_class') {
                var lengthOfArray_2 = document.querySelectorAll('input.' + input_class + '_2').length;
    ...
    function on_subrace_dropdown_option_click(e) {
        var targets_ul = document.getElementById(e.target.parentElement.parentElement.id);
    ...
    var add_events_for_dropdowns = function add_events_for_dropdowns(dropdown_option_checker, _id, _class, mouseAction, _function) {
